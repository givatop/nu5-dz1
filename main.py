...
def show_files(folder):
    [print(file) for file in os.listdir() if os.path.isfile(os.path.join(folder, file))]


def show_folders(folder):
    [print(file) for file in os.listdir() if not os.path.isfile(os.path.join(folder, file))]
